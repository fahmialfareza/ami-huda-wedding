...
$(document).ready(function () {
    ...
    if (window.matchMedia('(max-width: 767px)').matches || window.matchMedia('(max-width: 640px)').matches || window.matchMedia('(max-width: 667px)').matches || window.matchMedia('(max-width: 800px)').matches) {
